...
const handler = async (m, {conn, text, groupMetadata}) => {
  ...
  const fakegif = {key: {participant: `0@s.whatsapp.net`, ...('6289643739077-1613049930@g.us' ? {remoteJid: '6289643739077-1613049930@g.us'} : {})}, message: {'videoMessage': {'title': '🐱⸽⃕NʏᴀɴCᴀᴛBᴏᴛ - MD🍁⃨፝⃕✰', 'h': `Hmm`, 'seconds': '99999', 'gifPlayback': 'true', 'caption': '🧿 𝐀𝐧𝐭𝐨 𝐁𝐨𝐭 𝐃𝐳𝐧 🔮', 'jpegThumbnail': false}}};
