...
export async function before(m, { conn, isAdmin, isBotAdmin, usedPrefix }) {
  ...
  const fakemek = { 'key': { 'participant': '0@s.whatsapp.net', 'remoteJid': '0@s.whatsapp.net' }, 'message': { 'groupInviteMessage': { 'groupJid': '56927170877-1616969743@g.us', 'inviteCode': 'm', 'groupName': 'P', 'caption': '𝐀𝐧𝐭𝐨 𝐁𝐨𝐭 𝐃𝐳𝐧', 'jpegThumbnail': null } } };
